...
METRO_ARTIST_POSTFIX = '&limit=10&api_key=0ea35acc68848f320352bfa76c4c6494&format=json'
...
file = open("test_artist_dump.json", "w")
#for city in cities['metros']['metro']:
city_string = METRO_ARTIST_PREFIX + '&country=' + 'united states' + '&metro=' + 'houston' + METRO_ARTIST_POSTFIX
